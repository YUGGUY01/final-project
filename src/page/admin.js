...
export default function Admin() {
    ...
    const handleStatusChang = async (e, _id) => {
        ...
        try {
           ...
           await axios.put(`http://localhost:3000/admin/${_id}`, { 
            status: newStatus 
        });
                    ...
                    <thead>
                        <tr>
                            ...
                            <div style={{
                                ...
                                <AsyncSelect
                                    ...
                                    option: (provided, state) => ({
                                        ...provided,
                                        color: state.isSelected ? '#446894' : '#fff',
                                        backgroundColor: state.isSelected ? '#fff' : '#446894',
                                    }),
                            ...
                            <th>
                                ...
                                height:'2.5rem',padding:'4px',
                                alignContent:'center',
                                marginBottom:'2px'}}>สถานะโปรไฟล์</p>
                            </th>
                            <th>
                                <p style={{
                                    color:'#F3F4F8',
                                ...
                                backgroundColor:'#446894',
                                height:'2.5rem',padding:'4px',
                                alignContent:'center',marginBottom:'2px'}}>สถานะข้อมูล</p>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    .map((row) => (
                        <tr key={row._id}>
                            <td>
                                ...
                                borderRight: '3px solid', 
                                borderColor: '#fff',
                                backgroundColor:'#446894',height:'1.5rem',
